...
function Wrapper({
  ...
  return (
    <div className="px-[10rem]">
      <Heading2 className="mb-2">{name}</Heading2>
      {children}
    </div>
  );
}
    ...
    <>
      <main>
        <div className="w-full">
          ...
          <Wrapper name="Alert Dialog">
            <AlertDialog>
              <AlertDialogTrigger>
                <div className="rounded-md bg-primary p-3 text-white">Open</div>
              </AlertDialogTrigger>
              <AlertDialogContent>
                <AlertDialogHeader>
              ...
              <TabsContent value="password">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Change your password here. After saving your new password,
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <div className="space-y-1">
